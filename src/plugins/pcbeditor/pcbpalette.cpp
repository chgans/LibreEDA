...
QString PcbPalette::colorRoleLabel(PcbPalette::ColorRole role)
{
    ...
    {
        case TopPasteLayer:
            return QStringLiteral("Top Paste");
        case BottomPasteLayer:
            return QStringLiteral("Bottom Paste");
        case TopSolderLayer:
            return QStringLiteral("Top Solder");
        case BottomSolderLayer:
            return QStringLiteral("Bottom Solder");
        case DrillGuideLayer:
            return QStringLiteral("Drill Guide");
        case KeepOutLayer:
            return QStringLiteral("Keep Out Layer");
        case DrillDrawingLayer:
            return QStringLiteral("Drill Drawing");
        case MultiLayerLayer:
            return QStringLiteral("Multi Layer");
        case TopOverlayLayer:
            return QStringLiteral("Top Overlay");
        case BottomOverlayLayer:
            return QStringLiteral("Bottom Overlay");
        case Selection:
            return QStringLiteral("Selection");
        case Connection:
            return QStringLiteral("Connection");
        case DrcErrorMarker:
            return QStringLiteral("Drc Error Marker");
        case DrcErrorDetail:
            return QStringLiteral("Drc Error Detail");
        case LargeGrid:
            return QStringLiteral("Large Grid");
        case SmallGrid:
            return QStringLiteral("Small Grid");
        case LineGuide:
            return QStringLiteral("Line Guide");
        case PadHole:
            return QStringLiteral("Pad Hole");
        case ViaHole:
            return QStringLiteral("Via Hole");
        case TopPadMaster:
            return QStringLiteral("Top Pad Master");
        case BottomPadMaster:
            return QStringLiteral("Bottom Pad Master");
        case HighLight:
            return QStringLiteral("Highlight");
        case BoardLine:
            return QStringLiteral("Board Line");
        case BoardArea:
            return QStringLiteral("Board Area");
        case SheetLine:
            return QStringLiteral("Sheet Line");
        case SheetArea:
            return QStringLiteral("Sheet Area");
        case WorkspaceGradientStart:
            return QStringLiteral("Workspace Gradient Start");
        case WorkspaceGradientEnd:
            return QStringLiteral("Workspace Gradient End");
        default:
...
QString PcbPalette::colorRoleToAltiumName(PcbPalette::ColorRole role)
{
    ...
    {
        case TopPasteLayer:
            return QStringLiteral("LayerColors/TopPaste");
        case BottomPasteLayer:
            return QStringLiteral("LayerColors/BottomPaste");
        case TopSolderLayer:
            return QStringLiteral("LayerColors/TopSolder");
        case BottomSolderLayer:
            return QStringLiteral("LayerColors/BottomSolder");
        case TopOverlayLayer:
            return QStringLiteral("LayerColors/TopOverlay");
        case BottomOverlayLayer:
            return QStringLiteral("LayerColors/BottomOverlay");
        case DrillGuideLayer:
            return QStringLiteral("LayerColors/DrillGuide");
        case KeepOutLayer:
            return QStringLiteral("LayerColors/KeepOutLayer");
        case DrillDrawingLayer:
            return QStringLiteral("LayerColors/DrillDrawing");
        case MultiLayerLayer:
            return QStringLiteral("LayerColors/MultiLayer");
        case Connection:
            return QStringLiteral("LayerColors/ConnectLayer");
        // TBD: BackgroundLayer
        case DrcErrorMarker:
            return QStringLiteral("LayerColors/DRCErrorLayer");
        case LargeGrid:
            return QStringLiteral("LayerColors/GridColor1");
        case SmallGrid:
            return QStringLiteral("LayerColors/GridColor10");
        case PadHole:
            return QStringLiteral("LayerColors/PadHoleLayer");
        case ViaHole:
            return QStringLiteral("LayerColors/ViaHoleLayer");
        // TBD: Either LayerColors/HighlightLayer or WorkspaceColors/HighlightColor
        case HighLight:
            return QStringLiteral("LayerColors/HighlightLayer");
        case BoardLine:
            return QStringLiteral("WorkspaceColors/BoardLineColor");
        case BoardArea:
            return QStringLiteral("WorkspaceColors/BoardAreaColor");
        case SheetLine:
            return QStringLiteral("WorkspaceColors/SheetLineColor");
        case SheetArea:
            return QStringLiteral("WorkspaceColors/SheetAreaColor");
        case WorkspaceGradientStart:
            return QStringLiteral("WorkspaceColors/WorkspaceColor1");
        case WorkspaceGradientEnd:
            return QStringLiteral("WorkspaceColors/WorkspaceColor2");
        // TBD:
        /*
